...
\e[92m               `-..-`    \e[93m└─┘└─┘└─┘ \e[92m└─┘'
echo
echo -e '            \e[92m::: Tool By BASEL OMAR :::\e[0m'
echo -e '          \e[92m::: github.com/baselomar :::\e[0m'
echo -e "\e[92m"
...
then
xdg-open https://youtube.com/@baselomar390 2>/dev/null
elif [[ "$sit" = "5" || "$sit" = "five" ]];
then
xdg-open https://github.com/baselomar 2>/dev/null
elif [[ "$sit" = "6" || "$sit" = "six" ]];
then
...
echo -e '\e[92m   THANKS FOR READING SUBSCRIBE {BASEL OMAR}'
